...
```
    ...
    Info: Working in directory /Users/Alvin/Desktop/BIMM143/Week 7/Class 14
...
(https://reactome.org/) and R package available
...
Reactome is all about biological molecules and the pathways the
molecules that are within them. Meanwhile, KEGG is a different database
that has information on how genes interact within in a pathway and the
location of interactions. The databases difference can cause variations
